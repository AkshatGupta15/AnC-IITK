...
export default function CustomCard1({animation, image , text , heading}) {
  ...
  return (
    ...
    <MDBCard className='hover:scale-[1.02] mt-3 dark:bg-black dark:text-white border-2'>
      ...
      <MDBCardBody className=''>
        ...
        <MDBCardLink className="text-nav-links hover:text-white hover:bg-nav-links py-2 px-3 rounded-md font-[500]" href='#'>ReadMore</MDBCardLink>
      </MDBCardBody>
    </MDBCard>
    </div>
  );
