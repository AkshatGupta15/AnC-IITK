  ...
  return (
    <footer className="footer p-10 bg-neutral text-neutral-content">
      <aside>
        ...
        <p>Academics And Career Council</p>
      </aside>
      <nav>
    ...
    //             </div> */}
    //             <div>
    //                 <p className=' text-center md:text-[15px] text-[10px] font-serif '><CopyrightIcon/> AnC - Designed by <span className='font-semibold'>Akshat</span>, all rights reserved.</p>
    //             </div>
